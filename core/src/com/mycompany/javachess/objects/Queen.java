...
public class Queen extends Figure {
    public Queen(Side side, Vector2 boardPos, Cell cell, GameScreen gameScreen, GameController controller) {
        super(side, boardPos, cell, gameScreen, controller);
        type = Figures.queen;
        if(gameScreen == null) return;
        if(side == Side.white){
            sprite = new Texture(Gdx.files.internal("figures/white_queen.png"));
        }else{
            sprite = new Texture(Gdx.files.internal("figures/black_queen.png"));
        }
